...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_random_user_agent(self):
        ramdom_index = randint(0, len(self.user_agents_list)-1)
        return self.user_agents_list[ramdom_index]
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def _get_random_browser_header(self):
        ramdom_index = randint(0, len(self.headers_list)-1)
        return self.headers_list[ramdom_index]
